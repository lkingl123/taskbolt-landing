...
import { COMPANY_NAME, COMPANY_LOCATION, CONTACT_EMAIL, CONTACT_PHONE_E164, CONTACT_PHONE_DISPLAY } from '@/lib/constants';
...
// =====================================================================
/*
export default function Footer_OLD() {
    ...
    <footer className="bg-navy-900 border-t border-navy-700">
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              <Image src="/taskbolt_logo.png" alt="TaskBolt Logo" width={32} height={32} />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#how-it-works" className="text-gray-400 hover:text-electric-blue">How It Works</a></li>
              <li><a href="#contact" className="text-gray-400 hover:text-electric-blue">Get Free Audit</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="pt-8 border-t border-navy-700 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">© {currentYear} {COMPANY_NAME}. All rights reserved.</p>
      ...
      <div className="container mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 leading-relaxed">
              Local Utah contract labor for small businesses. Packing, assembly, kitting, prep work. We get it done so you can focus on what grows your business.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#pricing" className="text-gray-400 hover:text-electric-blue transition-colors duration-300">
                  Pricing
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="text-sm">Local pickup. No shipping.</li>
              <li>
                <a href={`tel:${CONTACT_PHONE_E164}`} className="hover:text-electric-blue transition-colors duration-300">
