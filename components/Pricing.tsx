...
const packages = [
  {
    ...
    setup: '$497',
    monthly: '$97',
    description: 'For solo operators ready to get organized',
    features: [
  ...
  },
  {
    ...
    setup: '$997',
    monthly: '$197',
    description: 'Complete operations for growing businesses',
    features: [
  ...
  },
  {
    ...
    setup: 'Custom',
    monthly: 'Custom',
    description: 'Fully tailored solutions for complex businesses',
    features: [
      'Everything in Pro',
      'Custom development',
      'API integrations',
